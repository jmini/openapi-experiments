...
public class StoreApi  {
  ...
  @Inject StoreApiService delegate;
    ...
    @ApiOperation(value = "Returns pet inventories by status", notes = "Returns a map of status codes to quantities", response = Map.class, responseContainer = "Map", tags={ "store" })
    @ApiResponses(value = { 
