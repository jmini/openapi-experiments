...
public interface PetApi  {
    ...
    public Response addPet(@ApiParam(value = "" ) Pet pet,@Context SecurityContext securityContext);
    ...
    public Response updatePet(@ApiParam(value = "" ) Pet pet,@Context SecurityContext securityContext);
