package fr.jmini.openapi.openapitools.googleapiclient;

import fr.jmini.openapi.openapitools.googleapiclient.api.*;
...
public class ApiClient {
    ...
    public LoremApi loremApi() {
        return new LoremApi(this);
    }
