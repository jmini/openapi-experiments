...
public class IpsumWithReqSpecApiTest {
    ...
    public void testWith() {
        ...
        api.pingGet()
            ...
            .customQuery(customParameterValue1)
            .execute(r -> r.prettyPeek());

        String customParameterValue2 = "param2";
        api.pingGet()
            .reqSpec(r -> r.addHeader("x-header-c", counterC.nextValue()))
            .customQuery(customParameterValue2)
            .execute(r -> r.prettyPeek());
        ...
        Assertions.assertThat(request1.getQueryStringParameterList())
            .describedAs("query string parameters")
            .hasSize(1);
        Parameter param1 = request1.getQueryStringParameterList()
            .get(0);
        Assertions.assertThat(
            param1.getName()
                .getValue()
        )
            .describedAs("query parameter name")
            .isEqualTo("custom");
        Assertions.assertThat(param1.getValues())
            .describedAs("query parameter values")
            .hasSize(1);
        Assertions.assertThat(
            param1.getValues()
                .get(0)
            ...
            .describedAs("query parameter unique value")
            .isEqualTo(customParameterValue1);
        Assertions.assertThat(request1.getFirstHeader("x-header-a"))
            .describedAs("first header 'x-header-a' value")
            .isEqualTo("a_value_1");
        Assertions.assertThat(request1.getFirstHeader("x-header-b"))
            .describedAs("first header 'x-header-a' value")
            .isEqualTo("b_value_1");
        Assertions.assertThat(request1.getFirstHeader("x-header-c"))
            .describedAs("first header 'x-header-a' value")
            .isEqualTo("c_value_1");
        ...
        Assertions.assertThat(request2.getQueryStringParameterList())
            .describedAs("query string parameters")
            .hasSize(1);
        Parameter param2 = request2.getQueryStringParameterList()
            .get(0);
        Assertions.assertThat(
            param2.getName()
                .getValue()
            ...
            .describedAs("query parameter name")
            .isEqualTo("custom");
        Assertions.assertThat(param2.getValues())
            .describedAs("query parameter values")
            .hasSize(1);
        Assertions.assertThat(
            param2.getValues()
            ...
            .describedAs("query parameter unique value")
            .isEqualTo(customParameterValue2);
        Assertions.assertThat(request2.getFirstHeader("x-header-a"))
            .describedAs("first header 'x-header-a' value")
            .isEqualTo("a_value_2");
        Assertions.assertThat(request2.getFirstHeader("x-header-b"))
            .describedAs("first header 'x-header-a' value")
            .isEqualTo("b_value_2");
        Assertions.assertThat(request2.getFirstHeader("x-header-c"))
            .describedAs("first header 'x-header-a' value")
            .isEqualTo("c_value_2");
    }
}