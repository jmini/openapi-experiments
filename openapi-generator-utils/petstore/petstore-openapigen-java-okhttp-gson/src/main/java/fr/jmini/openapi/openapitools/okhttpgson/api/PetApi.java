...
import java.io.File;
import fr.jmini.openapi.openapitools.okhttpgson.model.Pet;
...
public class PetApi {
     ...
     */
    public okhttp3.Call addPetCall(Pet pet, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private okhttp3.Call addPetValidateBeforeCall(Pet pet, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        okhttp3.Call call = addPetCall(pet, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<Void> addPetWithHttpInfo(Pet pet) throws ApiException {
        okhttp3.Call call = addPetValidateBeforeCall(pet, null, null);
     ...
     */
    public okhttp3.Call addPetAsync(Pet pet, final ApiCallback<Void> callback) throws ApiException {
        ...
        okhttp3.Call call = addPetValidateBeforeCall(pet, progressListener, progressRequestListener);
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call updatePetCall(Pet pet, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = pet;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updatePetValidateBeforeCall(Pet pet, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        okhttp3.Call call = updatePetCall(pet, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<Void> updatePetWithHttpInfo(Pet pet) throws ApiException {
        okhttp3.Call call = updatePetValidateBeforeCall(pet, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call updatePetAsync(Pet pet, final ApiCallback<Void> callback) throws ApiException {
        ...
        okhttp3.Call call = updatePetValidateBeforeCall(pet, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call updatePetWithFormCall(String petId, String name, String status, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updatePetWithFormValidateBeforeCall(String petId, String name, String status, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call updatePetWithFormAsync(String petId, String name, String status, final ApiCallback<Void> callback) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call uploadFileAsync(Long petId, String additionalMetadata, File file, final ApiCallback<Void> callback) throws ApiException {
