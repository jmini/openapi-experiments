...
public class StoreApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getOrderByIdCall(String orderId, final ProgressResponseBody.ProgressListener _progressListener, final ProgressRequestBody.ProgressRequestListener _progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOrderByIdValidateBeforeCall(String orderId, final ProgressResponseBody.ProgressListener _progressListener, final ProgressRequestBody.ProgressRequestListener _progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getOrderByIdAsync(String orderId, final ApiCallback<Order> _callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call placeOrderCall(Order order, final ProgressResponseBody.ProgressListener _progressListener, final ProgressRequestBody.ProgressRequestListener _progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call placeOrderValidateBeforeCall(Order order, final ProgressResponseBody.ProgressListener _progressListener, final ProgressRequestBody.ProgressRequestListener _progressRequestListener) throws ApiException {
        

        okhttp3.Call localVarCall = placeOrderCall(order, _progressListener, _progressRequestListener);
        return localVarCall;
    ...
    public ApiResponse<Order> placeOrderWithHttpInfo(Order order) throws ApiException {
        okhttp3.Call localVarCall = placeOrderValidateBeforeCall(order, null, null);
        Type localVarReturnType = new TypeToken<Order>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call placeOrderAsync(Order order, final ApiCallback<Order> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = placeOrderValidateBeforeCall(order, _progressListener, _progressRequestListener);
        Type localVarReturnType = new TypeToken<Order>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
