...
import fr.jmini.openapi.openapitools.api.factories.UserApiServiceFactory;
...
public class UserApi  {
   ...
   public UserApi(@Context ServletConfig servletContext) {
    ...
    public Response createUser(@ApiParam(value = "Created user object" ) @Valid User user
,@Context SecurityContext securityContext)
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "successful operation", response = Void.class) })
    public Response createUsersWithArrayInput(@ApiParam(value = "List of user object" ) @Valid List<User> user
,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "successful operation", response = Void.class) })
    public Response createUsersWithListInput(@ApiParam(value = "List of user object" ) @Valid List<User> user
,@Context SecurityContext securityContext)
    throws NotFoundException {
...
,@ApiParam(value = "Updated user object" ) @Valid User user
,@Context SecurityContext securityContext)
    throws NotFoundException {
