...
public class PolymorphicApiServiceImpl extends PolymorphicApiService {
    @Override
    public Response getPolymorphic(SecurityContext securityContext) throws NotFoundException {
        // do some magic!
