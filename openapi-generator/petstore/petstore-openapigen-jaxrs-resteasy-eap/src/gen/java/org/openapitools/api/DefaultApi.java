...
public interface DefaultApi  {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "successful operation", response = Void.class) })
    public Response createUsersWithArrayInput(@ApiParam(value = "List of user object" ) List<User> user,@Context SecurityContext securityContext);
    @POST
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "successful operation", response = Void.class) })
    public Response createUsersWithListInput(@ApiParam(value = "List of user object" ) List<User> user,@Context SecurityContext securityContext);
    @DELETE
    ...
    public Response placeOrder(@ApiParam(value = "order placed for purchasing the pet" ) Order order,@Context SecurityContext securityContext);
    @PUT
